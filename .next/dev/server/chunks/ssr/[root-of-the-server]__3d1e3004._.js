...
function BarberProvider({ children }) {
    ...
    const fetchFromSupabase = async ()=>{
        try {
            const [{ data: dbUsers, error: usersError }, { data: dbBarbers }, { data: dbServices }, { data: dbAppointments }, { data: dbPromotions }, { data: dbProducts }, { data: dbConfig }, { data: dbExpenses }, { data: dbIncomes }] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('barbeiros').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('servicos').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('agendamentos').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('promocoes').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('estoque').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('configuracoes_loja').select('*').single(),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('despesas').select('*'),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('entradas_avulsas').select('*')
            ]);
    ...
    const login = async (email, password)=>{
        ...
        if (email === 'marciel_farias@admin.com' && password === '150326') {
            ...
            const { data: dbAdmin, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').upsert([
                {
                    nome: 'Marciel',
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('*').eq('email', email).eq('senha', password).single();
        if (error || !data) {
    ...
    const register = async (name, email, password, role, phone)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').insert([
            {
                nome: name,
                email,
                senha: password,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange(async (event, session)=>{
            if (event === 'SIGNED_IN' && session?.user) {
                ...
                const { data: existingUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('*').eq('email', user.email).single();
                let finalUser;
                if (existingUser) {
                    finalUser = {
                        id: existingUser.id,
                    ...
                    const { data: newUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').insert([
                        {
    ...
    const addAppointment = async (appData)=>{
        ...
        const { data: newApp, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('agendamentos').insert([
            {
    ...
    const updateAppointmentStatus = async (id, status)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('agendamentos').update({
            status
        }).eq('id', id);
        if (error) {
    ...
    const addService = async (data)=>{
        const { data: newService, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('servicos').insert([
            {
                nome: data.name,
    ...
    const updateService = async (id, data)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('servicos').update(updateData).eq('id', id);
        if (error) {
    ...
    const removeService = async (id)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('servicos').delete().eq('id', id);
        if (error) {
    ...
    const addBarber = async (data)=>{
        ...
        const { data: existingUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('*').eq('email', data.email).single();
        if (existingUser) {
            ...
            const { data: newUser, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').insert([
                {
                    nome: data.name,
                    email: data.email,
        ...
        const { data: newBarber, error: barberError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('barbeiros').insert([
            {
                usuario_id: userId,
                nome: data.name,
    ...
    const updateBarber = async (id, data)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('barbeiros').update(updateData).eq('id', id);
        if (error) {
    ...
    const removeBarber = async (id)=>{
        ...
        const { error: barberError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('barbeiros').delete().eq('id', id);
        if (barberError) {
            console.error("Erro ao remover barbeiro:", barberError);
            return;
        }
        const { error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').delete().eq('id', barber.userId);
    ...
    const updateUser = async (id, data)=>{
        ...
        if (data.photo !== undefined) updateData.foto_url = data.photo;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').update(updateData).eq('id', id);
        if (error) {
    ...
    const updateShopConfig = async (data)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('configuracoes_loja').upsert(updateData);
        if (error) {
    ...
    const addPromotion = async (data)=>{
        const { data: newPromo, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('promocoes').insert([
            {
                tag: data.tag,
                titulo: data.title,
                descricao: data.description,
    ...
    const updatePromotion = async (id, data)=>{
        ...
        if (data.active !== undefined) updateData.ativo = data.active;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('promocoes').update(updateData).eq('id', id);
        if (error) {
    ...
    const removePromotion = async (id)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('promocoes').delete().eq('id', id);
        if (error) {
    ...
    const addProduct = async (data)=>{
        const { data: newProds, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('estoque').insert([
            {
                nome: data.name,
    ...
    const updateProduct = async (id, data)=>{
        ...
        if (data.active !== undefined) updateData.ativo = data.active;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('estoque').update(updateData).eq('id', id);
        if (error) {
    ...
    const removeProduct = async (id)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('estoque').delete().eq('id', id);
        if (error) {
    ...
    const addExpense = async (data)=>{
        const { data: newExpense, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('despesas').insert([
            {
                label: data.label,
                value: data.value,
                date: data.date,
    ...
    const addIncome = async (data)=>{
        const { data: newIncome, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('entradas_avulsas').insert([
            {
                label: data.label,
                value: data.value,
                date: data.date,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d1e3004._.js.map