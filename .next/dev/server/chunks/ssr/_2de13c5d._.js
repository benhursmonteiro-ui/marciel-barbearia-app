...
function AdminFinanceiro() {
    ...
    const dayData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const income = dayAppointments.reduce((acc1, app)=>acc1 + app.price, 0);
        const commissions = dayAppointments.reduce((acc1, app)=>acc1 + (app.commission || 0), acc);
        const dayExpenses = expenses.filter((exp)=>exp.date === selectedDate);
        const totalExp = dayExpenses.reduce((acc1, exp)=>acc1 + exp.value, 0);
        return {
    ...
    const monthlyStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const income = monthApps.reduce((acc1, app)=>acc1 + app.price, 0);
...
//# sourceMappingURL=_2de13c5d._.js.map